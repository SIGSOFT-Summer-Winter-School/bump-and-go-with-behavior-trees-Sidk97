...
As an open-source project, we welcome and encourage the community to submit patches directly. In our collaborative open source environment, standards and methods for submitting changes help reduce the chaos that can result from an active development community.
...
To make a good faith effort to ensure licensing criteria are met, this repo requires the Developer Certificate of Origin (DCO) process to be followed.
